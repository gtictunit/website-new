                                ...
                                <div class="container-fluid div1">
                                    <div class="row dvrw1">
                                        <div class="col-md-12 divformheading">
                                            <i class="glyphicon glyphicon-plus ispace"></i>Add Pastor's Desk
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-md-6 formtext">
                                                    <div class="container-fluid">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" id="title" name="pd_topic" minlength="3" require/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 formtext">
                                                    <div class="container-fluid">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" id="writer" name="pd_writer" minlength="3" require/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 formtext">
                                                    <div class="container-fluid">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <select class="form-control" id="day" name="pd_day">
                                                                    <?php echo $day; ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-6 formtext">
                                                    <div class="container-fluid">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <select class="form-control" id="month" name="pd_month">
                                                                    <?php echo $month; ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-6 formtext">
                                                    <div class="container-fluid">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <select class="form-control" id="year" name="pd_year">
                                                                    <?php echo $year; ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="row formrow">
                                        <div class="container">
                                                <div class="col-md-12 formtext">
                                                    <textarea class="form-control" name="pd_message"  id="basic-example"></textarea>
                                                </div>
                                    </div>
                                    </div>
                                    <div class="row formrow">
