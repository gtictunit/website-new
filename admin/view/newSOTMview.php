<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sotm = new sermonMonth();
        $message = $sotm->newSermonMonth();
    }
?>    
<!DOCTYPE HTML>
<html lang="en">
                                ...
                                <div class="container-fluid div1">
                                    <div class="row dvrw1">
                                        <div class="col-md-12 divformheading">
                                            <i class="glyphicon glyphicon-plus ispace"></i>Add Sermon of the Month
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-md-6 formtext">
                                                    <div class="container-fluid">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" id="title" name="sotm_topic" minlength="3" require/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 formtext">
                                                    <div class="container-fluid">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" id="writer" name="sotm_preacher" minlength="3" require/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="container-fluid">
                                                        <div class="row">
                                                            <div class="col-md-3 ">Month</div>
                                                                <div class="col-md-9">
                                                                    <select class="form-control" id="month" name="sotm_month">
                                                                        <?php echo $month; ?>
                                                                    </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="container-fluid">
                                                        <div class="row">
                                                            <div class="col-md-3 ">Year</div>
                                                                <div class="col-md-9">
                                                                    <select class="form-control" id="year" name="sotm_year">
                                                                        <?php echo $year; ?>
                                                                    </select>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="row formrow">
                                        <div class="container">
                                                <div class="col-md-12 formtext">
                                                    <textarea class="form-control" name="sotm_message"  id="basic-example"></textarea>
                                                </div>
                                    </div>
                                    </div>
                                    <div class="row formrow">
