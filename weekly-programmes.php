...
<div>
  ...
  <body class="bg-body-secondary">
    ...
    <div class="mx-auto container-xl">
      <div class="swiper slider-container mySwiper">
                ...
                <div class="card-body">
                  ...
                  <div class="">
                    <span class="d-flex gap-3 align-items-center">
                      <p class="p-0 m-0 time">Monday - Friday, 4:30pm - 6pm</p>
                    </span>
                  </div>
                  </p>
                </div>
              ...
              <div class="card"><a class="img-container" href="#">
                ...
                <div>
                  <div class="card-body">
                    ...
                    <p class="card-text desc">Some text to describe the activity.</p>

                    <p class="card-text">
                    <div class="">
                      <span class="d-flex gap-3 align-items-center">
                        <p class="p-0 m-0 time">Sundays, 9:00am - 11:30am</p>
                      </span>
                    </div>
                    </p>
                  </div>
            ...
            <div class="card"><a class="img-container" href="#">
              ...
              <div>
                <div class="card-body">
                  ...
                  <div class="">
                    <span class="d-flex gap-3 align-items-center">
                      <p class="p-0 m-0 time">Sundays, 8am - 9am</p>
                    </span>
                  </div>
                  </p>
                </div>
            ...
            <div class="card"><a class="img-container" href="#">
              ...
              <div>
                <div class="card-body">
                  ...
                  <p class="desc">Spiritual growth classes at the Discipleship cell centres</p>

                  <p class="card-text">
                  <div class="">
                    <span class="d-flex gap-3 align-items-center">
                      <p class="p-0 m-0 time">Tuesdays, 5:30pm - 6:30pm</p>
                    </span>
                  </div>
                  </p>
                </div>
            ...
            <div class="card"><a class="img-container" href="#">
              ...
              <div>
                <div class="card-body">
                  ...
                  <p class="desc">Time for in-depth study of God's word and the move of the HOLY SPIRIT</p>

                  <p class="card-text">
                  <div class="">
                    <span class="d-flex gap-3 align-items-center">
                      <p class="p-0 m-0 time">Thursdays, 4:30pm - 6pm</p>
                    </span>
                  </div>
                  </p>
                </div>
            ...
            <div class="card"><a class="img-container" href="#">
              ...
              <div>
                <div class="card-body">
                  ...
                  <p class="desc">Prayer meeting at the discipleship cell centres.</p>

                  <p class="card-text">
                  <div class="">
                    <span class="d-flex gap-3 align-items-center">
                      <p class="p-0 m-0 time">Friday, 5:00pm - 6:00pm</p>
                    </span>
                  </div>
                  </p>
                </div>
  ...
  background-color: #3e8e41;
      ...
      /*       
      .card-body, .card-body span, .card-body h4, .card-body p{
